...
<body>
                        ...
                        <ul class="dropdown-menu services_drop_menu mt-3" aria-labelledby="servicesDropdown"
                            ...
                            <div class="row  ">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <li><a class="dropdown-item services_drop" href="maxilloFaciaSurgery.php">Maxillo
                                            facial
                                            Surgery</a></li>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <li><a class="dropdown-item services_drop" href="radiology.php">Radiology</a></li>
    ...
    <main id="main">
        ...
        <section class="mt-2 Abouthome1">
            <div class="container">
                <h2 class="docHead">Services</h2>
                <p class="docPara mb-3">Neurostar Hospital offers advanced neurological services, specializing in
                    comprehensive care for conditions such as stroke, epilepsy, and brain injuries with cutting-edge
