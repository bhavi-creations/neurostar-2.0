    ...
    <div class="container">
      <div class="row">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to neurostarhospital,
              accessible from
              <a
                href="https://neurostarhospital.com/"
                rel="external nofollow noopener"
                target="_blank">https://neurostarhospital.com/</a>
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            <p>
              ...
              <a
                href="https://neurostarhospital.com/contact.php"
                rel="external nofollow noopener"
                target="_blank">https://neurostarhospital.com/contact.php</a>
            </p>
          </li>
          <li>
            <p>By phone number: 9885943399</p>
          </li>
        </ul>
      </div>
    </div>
