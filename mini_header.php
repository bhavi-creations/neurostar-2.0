...
<head>
    ...
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.0/css/bootstrap.min.css">
     ...
     <meta name="google-site-verification" content="kigmGct2S_sfe95jJeDLi57mejwXiohWvllwveeh8dg" />
                            ...
                            <div class="row  ">
                                <div class="col-md-4">
                                    ...
                                    <li><a class="dropdown-item services_drop" href="generalMedicine.php">General
                                            Medicine</a></li>
                                    <li><a class="dropdown-item services_drop" href="gynocology.php">Gynecology </a></li>
                                </div>
                                <div class="col-md-4">
